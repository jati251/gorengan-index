...
export function BottomStickyTickerTape() {
  ...
  return (
    <div
      ...
      className="fixed bottom-0 left-0 right-0 z-40 h-9 bg-[#3c3f5f] border-t border-white/[0.08] flex items-center font-mono select-none overflow-hidden transform-gpu [transform:translateZ(0)]"
